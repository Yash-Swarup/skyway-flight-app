                ...
                >
                  <div style={{ flex: 1, minWidth: 200 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '0.75rem' }}>
                      ...
                      <span style={{
                        ...
                        fontSize: '0.72rem', color: cfg.color, textTransform: 'capitalize',
                      }}>
                        <StatusIcon size={11} />
                        {booking.status}
                      </span>
                    ...
                    {flight && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
                        ...
                        <div style={{ color: '#64748b', fontSize: '0.8rem' }}>
                          {format(new Date(flight.departs_at), 'EEE, dd MMM yyyy · HH:mm')}
                        </div>
                        {seat && (
                          <span style={{
                            background: 'rgba(56,189,248,0.1)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontFamily: "'Space Mono', monospace", fontWeight: 700, color: '#f59e0b' }}>
                        ₹{booking.total_price.toLocaleString('en-IN')}
                      </div>
                      <div style={{ fontSize: '0.75rem', color: '#64748b' }}>
                        {format(new Date(booking.booked_at), 'dd MMM yyyy')}
                      </div>
                    </div>
